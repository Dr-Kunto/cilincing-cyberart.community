// <![CDATA[
// all colours must be in format '#ffffff' and not 'white' or 'rgb(255, 255, 255)'
var fgcolour="#ff0000"; // foreground colour
var hlcolour="#ffffff"; // highlight colour
var bgcolour="#0000ff"; // background colour
var glcolour="#f40000"; // colour of glow around letters
